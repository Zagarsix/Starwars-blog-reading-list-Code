   ...
   /*  useEffect(() => {
    ...
    return (
        ...
        <>
            ...
            <h1 className="fs-5 text-center mb-4">STAR WARS VEHICLES</h1>
            {store.vehicles.map(({ name }, index) => {
                            ...
                            <div className="row gx-5 align-items-center">
                                ...
                                <div className="col-lg-6">
                                    ...
                                    <div className="d-flex align-items-end justify-content-between">
                                        <Link className="btn btn-outline-success" to={`/vehiclesDetails/${index}`} >Learn more</Link>
